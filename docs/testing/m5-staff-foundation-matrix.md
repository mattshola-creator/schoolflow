...
| ---------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Staff identity   | Authorized owner creates and reads Person, staff profile, employment and assignment atomically | Non-member Person/profile visibility and direct-ID access denied                            |
...
The final deployed journey used a confirmed disposable QA identity. It verified live setup, register search, Staff 360, cross-tenant direct-ID denial, logout and health, then removed both QA tenants, both staff identities and the QA Auth user. Cleanup verification confirmed the permanent owner remained present.
